...
namespace diler.Dal
{
    public class Database2
    {
        ...
        public Database2()
        {
            //this.connetionString = @"Data Source=.;Initial Catalog=db_diler;Integrated Security=True;User ID=DavutERYILMAZ\Davut;Password=";//localhost
            ...
            //SELECT DISTINCT TABLOTIP FROM dbo.API_DB_001 WHERE (UNITE='ch') AND (FIRMA = 'DILER')
        ...
        {
            return rm_veriler_select(dokum_no, tarih, tarih2);
        }

        public List<Rm_veriler> rm_veriler_select(int dokum_no = 0, int tarih = 0, int tarih2 = 0)
        {
