<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YaziciCelikhaneRapor.aspx.cs" Inherits="diler.Web.Forms.holding_raporlari.YaziciCelikhaneRapor" %>
            ...
            <form id="form_rapor" method="post" runat="server">
                ...
                <div class="row icon-list" style="padding: 5px 0; padding-bottom: 0;">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-md-3">
                            <a href="DilerCelikhaneRapor.aspx" title="Diler Çelikhane Raporları">Diler Çelikhane İçin Tıklayın<i class="ion-arrow-right-a"></i>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-border panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title " style="text-align: center; font-size: 21px;">Yazıcı Çelikhane Üretimi</h3>
                            </div>
