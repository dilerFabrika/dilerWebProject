<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilmasinRapor.aspx.cs" Inherits="diler.Web.Forms.holding_raporlari.FilmasinRapor" %>
            ...
            <form id="form_rapor" method="post" runat="server">
                ...
                <div class="row tablolar">
                    <div class="col-sm-6">
                        <div class="panel panel-border panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title " style="text-align: center; font-size: 21px; color: #00F;">Kangal Üretimi</h3>
                            </div>
                                    ...
                                    <div class="panel-body table-rep-plugin table-rapor">
                                        ...
                                        <div class="table-responsive" data-pattern="priority-columns">
                                            <table id="tech-companies-2" class="table table-small-font table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th data-priority="1">Çap</th>
                                                        <th data-priority="3">Kalite</th>
                                    ...
                                    <div class="panel-body table-rep-plugin table-rapor">
                                        ...
                                        <div class="table-responsive" data-pattern="priority-columns">
                                            <table id="tech-companies-4" class="table table-small-font table-bordered table-striped tbl_durus_ayrintisi">
                                                ...
                                                <tbody>
                                                    <!-- jQuery kullanmadan durus ayrintisi getirmek icin. <asp:PlaceHolder ID="ph_durus_ayrintisi" runat="server"></asp:PlaceHolder> -->
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-border panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title " style="text-align: center; font-size: 21px; color: #9b3401;">Çubuk Üretimi</h3>
                            </div>
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-md-7">
                                    <div class="panel-body table-rep-plugin table-rapor">
                                        ...
                                        <div class="table-responsive" data-pattern="priority-columns">
                                            <table id="tech-companies-5" class="table table-small-font table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <asp:PlaceHolder ID="ph_cubuk_uretim" runat="server"></asp:PlaceHolder>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body table-rep-plugin table-rapor">
                                        ...
                                        <div class="table-responsive" data-pattern="priority-columns">
                                            <table id="tech-companies-6" class="table table-small-font table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <asp:PlaceHolder ID="ph_cubuk_uretim_ozet" runat="server"></asp:PlaceHolder>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
