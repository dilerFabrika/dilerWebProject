<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HHTonajlari.aspx.cs" Inherits="diler.Web.Forms.holding_raporlari.HHTonajlari" %>
            ...
            <form id="form_rapor" method="post" runat="server">
                ...
                <div class="tablolar panel panel-border panel-primary">
                    <div class="panel-heading" style="margin-bottom:10px;">
                        <h3 class="panel-title" style="text-align: center; font-size: 21px;">Haddehane Üretimi</h3>
                    </div>
                    <div class="col-sm-6">
                        <div class="panel">
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-border panel-primary">
                            <div class="col-md-12" style="margin-right: 0; padding: 0;">
                                <div class="panel-body table-rep-plugin table-rapor">
                                    <p class="tbl_baslik td_kahve" style="color:#FFF;">Filmaşin</p>
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-3" class="table table-small-font table-bordered table-striped">
                                            <asp:PlaceHolder ID="ph_f_ch_uretimi" runat="server"></asp:PlaceHolder>
                                        </table>
                                    </div>
                                </div>
                            </div>
