<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Izlenebilirlik_ikitarih_arasi.aspx.cs" Inherits="diler.Web.Forms.EndMuh.Izlenebilirlik_ikitarih_arasi" %>
    ...
    <div class="content">
        <form class="form-horizontal" role="form" enctype="multipart/form-data" runat="server">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs4">
                    <p style="text-align: center; font-size: 18px; color: #ED4517; margin-left: 30px; font-weight: bold;">İKİ TARİH ARASI İZLENEBİLİRLİK</p>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12">
                            ...
                            <table id="tech-companies-1" class="table table-bordered table-striped ktk_izlenebilirlik">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Sonuç</th>
                                        <th>Ocak Önü</th>
                                        <th>Fırına Verilecek</th>
                                        <th>F.İ.E Hurda</th>
                                        <th>F.D.E Hurda</th>
                                        <th>Eğri kütük sayısı</th>
                                        <th>Çelik cinsi</th>
                                        <th>Açıklama</th>
                                    </tr>
                                </thead>
