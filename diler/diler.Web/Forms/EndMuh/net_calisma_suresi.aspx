<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="net_calisma_suresi.aspx.cs" Inherits="diler.Web.Forms.EndMuh.net_calisma_suresi" %>
    ...
    <div class="content">
        <form class="form-horizontal" role="form" enctype="multipart/form-data" runat="server">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs4">
                    <p style="text-align: center; padding: 10px; font-size: 18px; color: #890d62; margin-left: 30px; font-weight: bold;">NET ÇALIŞMA SÜRESİ</p>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12">
