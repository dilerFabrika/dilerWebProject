<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="celikhane_genel_uretim.aspx.cs" Inherits="diler.Web.Forms.WebRaporlar.celikhane_genel_uretim" %>
                        ...
                        <table class="table" style="padding: 0; margin: 0; border: none;">
                            <tbody>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <asp:ImageButton ID="ImageButton2" runat="server" Style="height: 23px; width: 29px; margin-left: 18PX;" OnClick="ImageButton1_Click"
