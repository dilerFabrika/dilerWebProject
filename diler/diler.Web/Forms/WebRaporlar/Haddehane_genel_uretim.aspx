<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Haddehane_genel_uretim.aspx.cs" Inherits="diler.Web.Forms.WebRaporlar.Haddehane_genel_uretim" %>
    ...
    <div class="content">
        <form class="form-horizontal" role="form" enctype="multipart/form-data" runat="server">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs4">
                    <p style="text-align: center; padding: 10px; font-size: 18px; color: #f71bd3; margin-left: 30px; font-weight: bold;">HADDEHANE ÜRETİM RAPORU</p>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs12">
                            ...
                            <table id="tech-companies-1" class="table table-bordered table-striped hh_uretim_raporu">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Uçbaş (Ton)</th>
                                        <th>Kısa Parça(Ton)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <asp:PlaceHolder ID="ph_hh_uretim_raporu" runat="server"></asp:PlaceHolder>
                                </tbody>
                            </table>
                        </div>
                    </div>
