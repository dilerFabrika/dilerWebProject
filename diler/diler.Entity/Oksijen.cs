...
{
    public class Oksijen
    {
        private int oksijen_id;
        private string oksijen_bilgitnm;
        ...
        public int Oksijen_id
        {
            get { return oksijen_id; }
            set
            {
                if (value < 0)
                {
        ...
        public string Oksijen_bilgitnm
        {
            get { return oksijen_bilgitnm; }
            set { oksijen_bilgitnm = value; }
        }
